...
\begin{enumerate}
    ...
    \end{flalign*}
    \begin{flalign*}
        Nm & = $\Sigma_{n=0}^{+\infty} nE_{0}e^{-\frac{nE_{0}}{k_{B}T}}$\text{or $(e^{\alpha x})' = \alpha e^{\alpha x}$} &\\
    ...
    \end{flalign*}\newline
    On a donc $E = \frac{Nm}{D}$ = $\frac{\frac{E_{0}e^{-\frac{E_{0}{k_{B}T}}}}{(1-e^{-\frac{E_{0}}{k_{B}T}})^{2}}}{\frac{1}{1 - e^{-\frac{E_{0}{k_{B}T}}}}}$
