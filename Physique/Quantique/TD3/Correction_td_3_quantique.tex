...
\begin{enumerate}
    ...
    \begin{flalign*}
        E\psi(x) & = -\frac{\hbar^{2}}{2m}\frac{d^{2}}{dx^{2}}\psi(x) + V\psi(x) &\\
                 & = -\frac{\hbar^{2}}{2m}\frac{d^{2}}{dx^{2}}\psi(x) + V\psi(x) &\\
                 & = \left(\frac{-\hbar^{2}}{2m}\Delta + V\right)\psi(x) &\\
                 & \left\{
                    \begin{array}{l}
                        V = 0\\
    ...
    \begin{flalign*}
        E & = \frac{p^{2}}{2m} = \frac{\hbar^{2}k^{2}}{2m} \text{ car (dualité onde-corpuscule) } &\\
    ...
    $\left\{
        ...
        \begin{array}{l}
            ...
            n = 3 : E_{3} = \frac{\hbar^{2}\pi^{2}}{2mL^{2}} \times 3^{2} = 9E_{f}\\
            n = \
