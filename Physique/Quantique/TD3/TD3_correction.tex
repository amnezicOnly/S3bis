...
\begin{enumerate}
    ...
    \begin{flalign*}
        \int_{0}^{L} A\sin\left(\frac{n\pi}{L}x\right) dx = 1 & \Longleftrightarrow \int_{0}^{L} \frac{A^{2}}{2} \left(1-\cos\left(\frac{2n\pi x}{L}\right)\right)dx = 1 &\\
...
\begin{flalign*}
    \left(A^{2}\sin\left(\frac{n\pi}{L}x\right)\right)^{2} & = A^{2}\sin{2}\left(\frac{n\pi}{L}x\right) \text{ or on sait que } \sin^{2}(x) = \frac{1-cos(2x)}{2} &\\
