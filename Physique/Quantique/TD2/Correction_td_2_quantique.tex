...
\begin{enumerate}
    ...
    \end{figure}
    \item La Figure 1 (juste au dessus) montre les spectres d'émission et d'absorption de l'atome d'hydrogène, mesurés en laboratoire. Calculer les longueurs d'onde des transitions du tableau ci-dessous et interpréter les spectres observés.
    \begin{center}
